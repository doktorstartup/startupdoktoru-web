  ...
  return (
    <section id="vc-network" className="py-20 md:py-28 max-w-7xl mx-auto px-6 sm:px-8">
      <div className="max-w-3xl mx-auto text-center mb-12">
        ...
        <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight">{en ? VC_HEADLINE_EN : VC_HEADLINE}</h2>
        <p className="text-muted-foreground text-lg mt-4">{en ? VC_SUBTEXT_EN : VC_SUBTEXT}</p>
      </div>
